...
> N-class lookup projection for `CTX-117-2026-08-30-6e46bf9-provider-20260829T212905Z`. Canonical system requirements remain in `contracts/system-v1.md`. Executable and provider boundaries remain authoritative. `[SRC-SYSTEM, REPOSITORY_FACT, N]`
...
This table describes tree `ec68fc87f77120dcc165b4326c908929a866335a`. It does not describe live process health. `[SRC-BASELINE, REPOSITORY_FACT, N]`
